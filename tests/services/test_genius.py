...
class TestGeniusService:
    ...
    @pytest.mark.parametrize(
        ("ok_status", "g_status"), [(True, 404), (False, 200), (False, 404)]
    )
            ...
            (
                {
                    "hits": [
                        ...
                        {
                            "result": {
                                "primary_artist": {"name": "artist_A_and_B", "id": 3}
                            }
                        },
                    ]
                },
                [{"id": 1, "name": "artist_A"}, {"id": 3, "name": "artist_A_and_B"}],
            ),
            (None, []),
        ],
    )
    ...
    #     mock_get_song_data.assert_called_with(
    #         {"title": "some_title", "lyrics_state": "complete", "primary_artist": {"name": "artist A"}}
    #     )
